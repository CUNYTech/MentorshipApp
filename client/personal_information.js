        ...
        <div>
            ...
            <form >
                <p>
                    ...
                    <input required="required" type="text" placeholder="John" />
                </p>

                <p>
                    <label >Last Name: </label>
                    <input required="required" type="text" placeholder="Doe" />
                </p>

                <p>
                    <label >Username: </label>
                    <input required="required" type="text" placeholder="mysuperusername690" />
                </p>
                ...
                <p>
                    ...
                    <input required="required" type="password" placeholder="eg. X8df!90EO" />
                </p>
                ...
                <p>
                    ...
                    <input required="required" type="text" placeholder="Harvard" />
                </p>
                <p>
                    <label>Number of times available to meet: </label>
                    <input placeholder="3 times a week" />
                </p>
                <p>
